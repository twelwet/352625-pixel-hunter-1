...
const gameScreenThree = render(template);

const backButton = gameScreenThree.querySelector(`.back`);

backButton.addEventListener(`click`, () => changeScreen(greetingScreen));

const gameOptions = [...gameScreenThree.querySelectorAll(`.game__option`)];

gameOptions.forEach((element) => element.addEventListener(`click`, () => changeScreen(statsScreen)));

export {gameScreenThree};
