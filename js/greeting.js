...
export const greetingScreen = render(template);

const asterisk = greetingScreen.querySelector(`.greeting__asterisk`);

asterisk.addEventListener(`click`, () => changeScreen(introScreen));
